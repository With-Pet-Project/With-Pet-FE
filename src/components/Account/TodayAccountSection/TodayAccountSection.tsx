...
import { AccountCalender, YearMonth, SelectPetProps } from 'lib/types/types';
import './TodayAccountSection.scss';

interface TodayAccountSectionProps {
  calenderData: AccountCalender;
  yearMonth: any;
  selectPet: SelectPetProps;
}
...
function TodayAccountSection({
  ...
  yearMonth,
  selectPet,
}: TodayAccountSectionProps): ReactElement {
  ...
  const handleEditSubmit = (event: React.MouseEvent<HTMLElement>): void => {
